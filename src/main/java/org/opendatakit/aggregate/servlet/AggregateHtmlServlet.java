...
public class AggregateHtmlServlet extends ServletUtilBase {
  ...
  public static final String PAGE_CONTENTS_SECOND = "sensor=false\" async></script>"
      ...
      + "  </head>"
      + "  <body style=\"border:1px transparent;\">"
      ...
      + "      </div>"
      + "    </noscript>" + "   <div id=\"not_secure_content\"></div><div id=\"error_content\"></div><div id=\"dynamic_content\" style=\"height:600px;border:1px transparent;box-sizing:border-box;\"></div>"
      + "  </body>"
      + "</html>";
